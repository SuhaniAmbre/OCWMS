<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="PPFEmp.aspx.cs" Inherits="OCWMS.PPFEmp" %>

<!DOCTYPE html>
<html lang="en">
<head runat="server">
    <title>Employee PPF Request</title>
    <style>
...
<body>
    <form id="form1" runat="server">
        ...
        <h2>Public Provident Fund (PPF) Request</h2>

      <div class="search-container">
  <label>Search by Employee ID or Name:</label><asp:TextBox ID="txtSearch" runat="server" Width="500px" Height="30px"></asp:TextBox>
  ...
  <br /><br />
        ...
        <asp:TextBox ID="txtAccountNumber" runat="server" Height="30px" Width="600px"></asp:TextBox>
        <br />
        <asp:RequiredFieldValidator ControlToValidate="txtAccountNumber" runat="server" ErrorMessage="Required" ForeColor="Red" />
        &nbsp;<asp:RegularExpressionValidator ControlToValidate="txtAccountNumber" runat="server" ValidationExpression="^\d+$" ErrorMessage="Only Numbers Allowed" ForeColor="Red" />
        <br />
        ...
        <asp:Button ID="btnClaim" runat="server" CssClass="button" Text="Claim EPF" OnClick="btnClaim_Click" />
