<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="PPFEmpNoti.aspx.cs" Inherits="OCWMS.PPFEmpNoti" %>
...
<h2>
    PPF Notifications
            ...
            <asp:GridView ID="gvNotifications" runat="server" CssClass="grid-style" AutoGenerateColumns="False" OnSelectedIndexChanged="gvNotifications_SelectedIndexChanged">
    <Columns>
        <asp:BoundField DataField="EmpName" HeaderText="Employee Name" />
        <asp:BoundField DataField="RequestAmount" HeaderText="Requested Amount" />
