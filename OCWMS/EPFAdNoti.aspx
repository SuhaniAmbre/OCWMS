<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="EPFAdNoti.aspx.cs" Inherits="OCWMS.EPFAdNoti" %>

<!DOCTYPE html>
<html>
<head>
    <title>EPF Requests - Admin</title>
    <style>
body {
    ...
    <form id="form1" runat="server">
        ...
        <asp:GridView ID="gvRequests" runat="server" AutoGenerateColumns="False" OnSelectedIndexChanged="gvRequests_SelectedIndexChanged">
            <Columns>
                ...
                <asp:BoundField DataField="UANNumber" HeaderText="UAN Number" />
