...
namespace OCWMS
{
    public partial class EPFEmpNoti : System.Web.UI.Page
    {
        ...
        private void LoadNotifications()
        {
            ...
            {
                SqlDataAdapter da = new SqlDataAdapter("SELECT EmpName, RequestAmount, RequestDate, Status, Message FROM EPF_Notifications", con);
