...
namespace OCWMS
{
    public partial class PPFEmpNoti : System.Web.UI.Page
    {
        ...
        private void LoadNotifications()
        {
            ...
            {
                SqlDataAdapter da = new SqlDataAdapter("SELECT EmpName, RequestAmount, RequestDate, Status, Message FROM PPF_Notifications", con);
