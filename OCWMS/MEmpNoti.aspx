<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="MEmpNoti.aspx.cs" Inherits="OCWMS.MEmpNoti" %>
...
<h2>
    ...
    <Columns>
        ...
        <asp:BoundField DataField="MediclaimReason" HeaderText="Mediclaim Reason" />
