<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="AlloAd.aspx.cs" Inherits="OCWMS.AlloAd" %>

<!DOCTYPE html>
<html>
<head>
    <title>Allowance Requests - Admin</title>
<style>
    /* Global Styles */
body {
...
<body>
    <form id="form1" runat="server">
        ...
        <asp:GridView ID="gvRequests" runat="server"  CssClass="gridview-table" AutoGenerateColumns="False" OnSelectedIndexChanged="gvRequests_SelectedIndexChanged">
            <Columns>
